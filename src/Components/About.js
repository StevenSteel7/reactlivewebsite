...
export default function About() {
 ...
 const [btnText,setBtnText] = useState("Enable Dark Mode") // TO set a text for a button
...
return (
          <div className="container" style={myStyle}> {/* // This style variable can be used to add dark mode */}
